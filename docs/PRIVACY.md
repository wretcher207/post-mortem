...
This document describes Post Mortem `0.1.2`. It is a plain account of what the
...
`0.1.2` does not upload that file.
...
Version `0.1.2` has no analytics, usage telemetry, remote crash reporting,
